            ...
            <div className="row align-items-center">
                    ...
                    <div className="row" style={{marginTop:"80px"}}>
                        <div className="col-auto" style={{marginRight:35}}>
                            ...
                            <h6 className="mt-3 font-weight-bold">
                                {formatNumber(props.data.travelers)} <span className="gray-500 font-weight-light">travelers</span>
                            </h6>
                        </div>
                        <div className="col-auto" style={{marginRight:35}}>
                            <img width="36" height="36" src={IconTreasure} alt={`${props.data.treasures} Travelers`}/>
                            <h6 className="mt-3 font-weight-bold">
                                {formatNumber(props.data.treasures)} <span className="gray-500 font-weight-light">treasures</span>
                            </h6>
                        </div>
                        <div className="col-auto">
                            <img width="36" height="36" src={IconCities} alt={`${props.data.cities} Travelers`}/>
                            <h6 className="mt-3 font-weight-bold">
                                {formatNumber(props.data.cities)} <span className="gray-500 font-weight-light">cities</span>
                            </h6>
                        </div>
                    </div>
                </div>
                <div className="col-6 pl-5">
                    <div style={{width:520, height:410}}>
                        ...
                        <img src={ImageHero_} alt="Room with couches" className="img-fluid position-absolute" style={{margin: '0 -15px -15px 0', zIndex:0}}/>
                    </div>
                </div>
            </div>
